...
type LiveProduct struct {
	...
	AvailableCoupons []AvailableCoupon `json:"available_coupons"` // 优惠券信息列表
	LotteryActivityInfo *LotteryActivityInfo `json:"lottery_activity_info"` // 福袋活动信息
}
