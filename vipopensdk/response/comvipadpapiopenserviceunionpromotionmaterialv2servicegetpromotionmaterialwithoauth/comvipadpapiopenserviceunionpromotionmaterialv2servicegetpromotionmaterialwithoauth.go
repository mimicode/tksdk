...
// com.vip.adp.api.open.service.UnionPromotionMaterialV2Service getPromotionMaterialWithOauth 获取推广素材列表——需要授权
...
type Data struct {
	...
	MaterialList []MaterialInfo `json:"materialList"` // 素材列表
}
