package comvipadpapiopenserviceuniongoodsv2servicequerycompetitormatchingproductwithoauth
...
type GoodsInfo struct {
	...
	CompetitorUrl   string   `json:"competitorUrl"`   // 竞品URL
	CompetitorPrice float64  `json:"competitorPrice"` // 竞品价格
	PriceDiff       float64  `json:"priceDiff"`       // 价格差异
}
