package comvipadpapiopenserviceuniongoodsv2servicegetgoodsdetailmarketingwithoauth
...
// getGoodsDetailMarketingWithOauth 2.0.0 获取指定商品id的商品信息(支持精准计算渠道用户到手价)-需要oauth授权
// http://vop.vip.com/apicenter/method?serviceName=com.vip.adp.api.open.service.UnionGoodsV2Service-2.0.0&methodName=getGoodsDetailMarketingWithOauth
...
type Success struct {
	...
	PromotionPrice         string                 `json:"promotionPrice"`         // (已废弃)全人群可用价，已计算可用券，不计算人群优惠,单位：元
