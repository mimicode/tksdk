...
// ComVipAdpApiOpenServiceUnionUrlV2ServiceGenByVIPUrlWithOauthRequest com.vip.adp.api.open.service.UnionUrlV2Service
// genByVIPUrlWithOauth 2.0.0 根据唯品会链接生成联盟链接-需要申请渠道工具商权限包权限
