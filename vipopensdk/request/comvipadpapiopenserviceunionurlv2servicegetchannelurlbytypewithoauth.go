...
// ComVipAdpApiOpenServiceUnionUrlV2ServiceGetChannelUrlByTypeWithOauthRequest com.vip.adp.api.open.service.UnionUrlV2Service
// getChannelUrlByTypeWithOauth 2.0.0 渠道根据落地页类型生链接口,需要申请渠道工具商权限包权限
