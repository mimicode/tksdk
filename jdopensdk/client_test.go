...
func TestJdUnionOpenChannelInvitecodeGetRequest(t *testing.T) {
	client := GetClient()
	getRequest := &request.JdUnionOpenChannelInvitecodeGetRequest{}
	var param = map[string]interface{}{
		"channelInviteReq": map[string]interface{}{
			"inviteType":  0,
			"channelType": 0,
		},
	}
	marshal, _ := json.Marshal(param)
	getRequest.AddParameter("360buy_param_json", string(marshal))
	var getResponse DefaultResponse = &jdunionopenchannelinvitecodeget.Response{}
	if err := client.Exec(getRequest, getResponse); err != nil {
		fmt.Println(err)
	} else {
...
func TestJdUnionOpenOrderAgentQueryRequest(t *testing.T) {
	client := GetClient()
	getRequest := &request.JdUnionOpenOrderAgentQueryRequest{}
	getRequest.AddParameter("360buy_param_json", `{"orderReq":{"pageIndex":1,"pageSize":20,"type":3,"startTime":"2021-08-02 11:45:00","endTime":"2021-08-02 11:50:00","fields":"goodsInfo,categoryInfo"}}`)
	var getResponse DefaultResponse = &jdunionopenorderagentquery.Response{}
	if err := client.Exec(getRequest, getResponse); err != nil {
		fmt.Println(err)
	} else {
...
func TestJdUnionOpenOrderRowSupplyQueryRequest(t *testing.T) {
	client := GetClient()
	getRequest := &request.JdUnionOpenOrderRowSupplyQueryRequest{}
	getRequest.AddParameter("360buy_param_json", `{"orderReq":{"pageIndex":1,"pageSize":20,"type":3,"startTime":"2021-08-02 11:45:00","endTime":"2021-08-02 11:50:00","fields":"goodsInfo,categoryInfo"}}`)
	var getResponse DefaultResponse = &jdunionopenorderrowsupplyquery.Response{}
	if err := client.Exec(getRequest, getResponse); err != nil {
		fmt.Println(err)
	} else {
		commonGetResponse := getResponse.(*jdunionopenorderrowsupplyquery.Response)
		fmt.Println(commonGetResponse.IsError())
		fmt.Println(commonGetResponse.Body)
	}
}
...
func TestJdUnionOpenPromotionIntelligenceQueryRequest(t *testing.T) {
	client := GetClient()
	getRequest := &request.JdUnionOpenPromotionIntelligenceQueryRequest{}
	var param = map[string]interface{}{
		"req": map[string]interface{}{
			"pageIndex": 1,
			"pageSize":  10,
	...
	marshal, _ := json.Marshal(param)
	getRequest.AddParameter("360buy_param_json", string(marshal))
	var getResponse DefaultResponse = &jdunionopenpromotionintelligencequery.Response{}
	if err := client.Exec(getRequest, getResponse); err != nil {
		fmt.Println(err)
	} else {
		commonGetResponse := getResponse.(*jdunionopenpromotionintelligencequery.Response)
		fmt.Println(commonGetResponse.IsError())
		fmt.Println(commonGetResponse.Body)
	}
}

func TestJdUnionOpenPromotionToolsIntelligenceQueryRequest(t *testing.T) {
	client := GetClient()
	getRequest := &request.JdUnionOpenPromotionToolsIntelligenceQueryRequest{}
	var param = map[string]interface{}{
		"req": map[string]interface{}{
			"pageIndex": 1,
			"pageSize":  10,
	...
	marshal, _ := json.Marshal(param)
	getRequest.AddParameter("360buy_param_json", string(marshal))
	var getResponse DefaultResponse = &jdunionopenpromotiontoolsintelligencequery.Response{}
	if err := client.Exec(getRequest, getResponse); err != nil {
		fmt.Println(err)
	} else {
		commonGetResponse := getResponse.(*jdunionopenpromotiontoolsintelligencequery.Response)
		fmt.Println(commonGetResponse.IsError())
		fmt.Println(commonGetResponse.Body)
	}
}

func TestJdUnionOpenGoodsRecommendQueryRequest(t *testing.T) {
	client := GetClient()
	getRequest := &request.JdUnionOpenGoodsRecommendQueryRequest{}
	var param = map[string]interface{}{
		"RecommendGoodsReq": map[string]interface{}{
			"skuId":   26898778009,
			"sceneId": 1,
		},
	}
	marshal, _ := json.Marshal(param)
	getRequest.AddParameter("360buy_param_json", string(marshal))
	var getResponse DefaultResponse = &jdunionopengoodsrecommendquery.Response{}
	if err := client.Exec(getRequest, getResponse); err != nil {
		fmt.Println(err)
	} else {
...
func TestJdUnionOpenStatisticsActivityBonusQueryRequest(t *testing.T) {
	client := GetClient()
	getRequest := &request.JdUnionOpenStatisticsActivityBonusQueryRequest{}
	var param = map[string]interface{}{
		"req": map[string]interface{}{
			"activityId": 1,
		},
	...
	marshal, _ := json.Marshal(param)
	getRequest.AddParameter("360buy_param_json", string(marshal))
	var getResponse DefaultResponse = &jdunionopenstatisticsactivitybonusquery.Response{}
	if err := client.Exec(getRequest, getResponse); err != nil {
		fmt.Println(err)
	} else {
