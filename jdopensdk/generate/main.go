...
request = ApiInfo{
		APIDESC:    "jd.union.open.channel.relation.get 渠道关系ID生成接口【申请】",
		APIORGNAME: "jd.union.open.channel.relation.get",
		APIURL:     "https://union.jd.com/openplatform/api/v2?apiName=jd.union.open.channel.relation.get",
		CHECKFIELDS: []CheckField{
			{
				FieldName:         "360buy_param_json",
				FieldNotNullCheck: true,
	...
	request = ApiInfo{
		APIDESC:    "jd.union.open.goods.recommend.query 相似品推荐接口【申请】",
		APIORGNAME: "jd.union.open.goods.recommend.query",
		APIURL:     "https://union.jd.com/openplatform/api/v2?apiName=jd.union.open.goods.recommend.query",
		CHECKFIELDS: []CheckField{
			{
				FieldName:         "360buy_param_json",
				FieldNotNullCheck: true,
	...
	request = ApiInfo{
		APIDESC:    "jd.union.open.promotion.intelligence.query 线报推广【申请】，获取京东商品段子、优惠信息、店铺及类目活动爆料信息，接口出参直接是转链后链接",
		APIORGNAME: "jd.union.open.promotion.intelligence.query",
		APIURL:     "https://union.jd.com/openplatform/api/v2?apiName=jd.union.open.promotion.intelligence.query",
		CHECKFIELDS: []CheckField{
			{
				FieldName:         "360buy_param_json",
				FieldNotNullCheck: true,
	...
	request = ApiInfo{
		APIDESC:    "jd.union.open.user.register.validate 实时RTA接口【申请】",
		APIORGNAME: "jd.union.open.user.register.validate",
		APIURL:     "https://union.jd.com/openplatform/api/v2?apiName=jd.union.open.user.register.validate",
		CHECKFIELDS: []CheckField{
			{
				FieldName:         "360buy_param_json",
				FieldNotNullCheck: true,
	...
	request = ApiInfo{
		APIDESC:    "jd.union.open.statistics.promotion.query 推广效果数据查询接口【申请】",
		APIORGNAME: "jd.union.open.statistics.promotion.query",
		APIURL:     "https://union.jd.com/openplatform/api/v2?apiName=jd.union.open.statistics.promotion.query",
		CHECKFIELDS: []CheckField{
			{
				FieldName:         "360buy_param_json",
				FieldNotNullCheck: true,
