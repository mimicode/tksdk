package jdunionopenpromotionintelligencequery
...
// Response jd.union.open.promotion.intelligence.query 线报推广【申请】：京东商品段子、优惠信息、店铺及类目活动爆料信息，接口出参直接是转链后链接
type Response struct {
	response.TopResponse
	Responce Responce `json:"jd_union_open_promotion_intelligence_query_responce"`
}
...
type IntelligenceResp struct {
	...
	StartTime     string  `json:"startTime"`     //线报开始时间
	EndTime       string  `json:"endTime"`       //线报结束时间
}
